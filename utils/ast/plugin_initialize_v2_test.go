	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:       filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "initialize", "plugin_biz_v2.go"),
				PluginPath: filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "plugin", "gva", "plugin.go"),
				ImportPath: `"DYCLOUD/plugin/gva"`,
			},
			wantErr: false,
		},
	}
