	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "api", "v1", "enter.go"),
				ImportPath:        `"DYCLOUD/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "router", "enter.go"),
				ImportPath:        `"DYCLOUD/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				Path:              filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "service", "enter.go"),
				ImportPath:        `"DYCLOUD/service/example"`,
