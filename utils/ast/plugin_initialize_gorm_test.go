	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "plugin", "gva", "initialize", "gorm.go"),
				ImportPath:  `"DYCLOUD/plugin/gva/model"`,
				StructName:  "User",
				PackageName: "model",
				IsNew:       false,
			},
