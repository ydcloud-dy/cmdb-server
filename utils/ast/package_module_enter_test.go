	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "router", "example", "enter.go"),
				ImportPath:  `api "DYCLOUD/api/v1"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "api", "v1", "example", "enter.go"),
				ImportPath:  `"DYCLOUD/service"`,
		...
		},
		{
			...
			fields: fields{
				...
				Path:        filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "service", "example", "enter.go"),
				ImportPath:  ``,
