	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				Path:            filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "plugin", "gva", "api", "enter.go"),
				ImportPath:      `"DYCLOUD/plugin/gva/service"`,
				StructName:      "User",
		...
		},
		{
			...
			fields: fields{
				...
				Path:            filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "plugin", "gva", "router", "enter.go"),
				ImportPath:      `"DYCLOUD/plugin/gva/api"`,
				StructName:      "User",
				StructCamelName: "user",
				ModuleName:      "userApi",
				GroupName:       "Api",
		...
		},
		{
			...
			fields: fields{
				...
				Path:            filepath.Join(global.DYCLOUD_CONFIG.AutoCode.Root, global.DYCLOUD_CONFIG.AutoCode.Server, "plugin", "gva", "service", "enter.go"),
				ImportPath:      "",
				StructName:      "User",
				StructCamelName: "user",
				ModuleName:      "",
