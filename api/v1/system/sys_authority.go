...
func (a *AuthorityApi) CreateAuthority(c *gin.Context) {
	...
	if *authority.ParentId == 0 && global.DYCLOUD_CONFIG.System.UseStrictAuth {
	...
	if err != nil {
		global.DYCLOUD_LOG.Error("创建成功，权限刷新失败。", zap.Error(err))
...
func (a *AuthorityApi) CopyAuthority(c *gin.Context) {
	...
	if err != nil {
		global.DYCLOUD_LOG.Error("拷贝失败!", zap.Error(err))
